...
export function Pagination({ hasNext, hasPrevious, nextURL, previousURL, onNext, onPrevious, nextTooltip, previousTooltip, nextKeys, previousKeys, plain, accessibilityLabel, label, }) {
    ...
    const previousClassName = classNames(styles.Button, newDesignLanguage && styles.newDesignLanguage, !label && styles.PreviousButton);
    const nextClassName = classNames(styles.Button, newDesignLanguage && styles.newDesignLanguage, newDesignLanguage && styles.rightButton, !label && styles.NextButton);
