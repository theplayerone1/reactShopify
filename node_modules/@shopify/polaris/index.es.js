...
import { CaretDownMinor, HorizontalDotsMinor, TickSmallMinor, AlertMinor, CaretUpMinor, CircleCancelMinor, CancelSmallMinor, CircleInformationMajorFilled, FlagMajorTwotone, CircleDisabledMajorFilled, CircleDisabledMajorTwotone, CircleAlertMajorFilled, CircleAlertMajorTwotone, CircleInformationMajorTwotone, CircleTickMajorFilled, CircleTickMajorTwotone, ChevronLeftMinor, MinusMinor, ChevronRightMinor, ArrowLeftMinor, ArrowRightMinor, DragDropMajorMonotone, CircleAlertMajorMonotone, SearchMinor, ChevronUpMinor, ChevronDownMinor, InfoMinor, QuestionMarkMajorTwotone, MobileCancelMajorMonotone, ExternalSmallMinor, ArrowUpDownMinor, CalendarMinor, EnableSelectionMinor, MobileHamburgerMajorMonotone } from '@shopify/polaris-icons';
...
if (typeof window !== 'undefined') {
  ...
  window.Polaris.VERSION = '4.16.1';
}

var polarisVersion = '4.16.1';
...
function Avatar(_ref) {
  ...
  var imageMarkUp = source && isAfterInitialMount && status !== Status.Errored ? React__default.createElement(Image, {
  ...
  var avatarBody = customer || !initials ? React__default.createElement("path", {
    fill: "currentColor",
...
function Icon(_ref) {
  ...
  var contentMarkup = {
    function: React__default.createElement(SourceComponent, {
    ...
    external: React__default.createElement("img", {
...
function Spinner(_ref) {
  ...
  var spinnerSVGMarkup = size === 'large' ? React__default.createElement("svg", {
    viewBox: "0 0 44 44",
  ...
  return React__default.createElement(React__default.Fragment, null, React__default.createElement("span", {
    className: className
  }, spinnerSVGMarkup), React__default.createElement("span", spanAttributes, accessibilityLabelMarkup));
}
...
function buildCustomProperties(themeConfig, newDesignLanguage, tokens) {
  ...
  return newDesignLanguage ? customPropertyTransformer(Object.assign(Object.assign({}, colorFactory(colors, colorScheme, mergedConfig)), tokens)) : buildLegacyColors(themeConfig);
}
...
var styles$i = {
  ...
  "newDesignLanguage": "Polaris-ActionMenu-MenuAction--newDesignLanguage",
...
function MenuAction(_ref) {
  ...
  var menuActionClassNames = classNames(styles$i.MenuAction, newDesignLanguage && styles$i.newDesignLanguage, disabled && styles$i.disabled);
...
function FocusManager(_ref) {
  ...
  return React__default.createElement(FocusManagerContext.Provider, {
    value: value
  }, children);
}
  ...
  _createClass(AppProvider, [{
    ...
    value: function render() {
      ...
      return React__default.createElement(FeaturesContext.Provider, {
        ...
        theme: theme
      }, React__default.createElement(MediaQueryProvider, null, React__default.createElement(FocusManager, null, children))))))))));
    }
  }]);
  ...
  _createClass(ComboBox, [{
    ...
    value: function render() {
      ...
      if (actionsBefore && actionsBefore.length > 0) {
        actionsBeforeMarkup = React__default.createElement(ActionList, {
          actionRole: "option",
      ...
      if (actionsAfter && actionsAfter.length > 0) {
        actionsAfterMarkup = React__default.createElement(ActionList, {
          actionRole: "option",
...
function RadioButton(_ref) {
  ...
  var iconMarkup = !newDesignLanguage && React__default.createElement("span", {
...
function Tag(_ref) {
  ...
  var className = classNames(styles$S.Tag, disabled && styles$S.disabled, onClick && styles$S.clickable, newDesignLanguage && styles$S.newDesignLanguage);
  ...
  var removeButton = onRemove ? React__default.createElement("button", {
    type: "button",
    "aria-label": ariaLabel,
  ...
  var tagMarkup = onClick ? React__default.createElement("button", {
    disabled: disabled,
    className: className,
    onClick: onClick
  }, children) : React__default.createElement("span", {
...
function FiltersInnerWrapper(props) {
  ...
  return React__default.createElement(FiltersInner, Object.assign({}, props, {
...
function FooterHelp(_ref) {
  ...
  }, React__default.createElement(Icon, iconProps)), React__default.createElement("div", {
...
var Navigation$1 = function Navigation(_ref) {
  ...
  var width = getWidth(logo, 104);
  var logoMarkup = logo && newDesignLanguage ? React__default.createElement("div", {
...
function Pagination(_ref) {
  ...
  var previousClassName = classNames(styles$1f.Button, newDesignLanguage && styles$1f.newDesignLanguage, !label && styles$1f.PreviousButton);
  var nextClassName = classNames(styles$1f.Button, newDesignLanguage && styles$1f.newDesignLanguage, newDesignLanguage && styles$1f.rightButton, !label && styles$1f.NextButton);
...
function PolarisTestProvider(_ref) {
  ...
  }, React__default.createElement(FocusManager, null, React__default.createElement(FrameContext.Provider, {
    value: mergedFrame
  }, children))))))))))));
}
...
var TopBar = function TopBar(_ref) {
  ...
  var scrollListenerMarkup = newDesignLanguage ? React__default.createElement(EventListener, {
    event: "scroll",
